...
- [Activation Functions and the Vanishing Gradient](./notebooks/Activation_Functions_and_Vanishing_Gradient.ipynb)
...
- [Convolutional Neural Networks (CNNs) with Keras](./notebooks/Convolutional_Neural_Networks_with_Keras.ipynb)
